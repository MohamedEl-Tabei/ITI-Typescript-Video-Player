...
class VideoPlayer extends VideoPlayerAbstract {
    constructor(container, src, width, skipTime, theme) {
        ...
        super(src, container, width, skipTime, Object.assign(Object.assign({}, myTheme), theme));
        this.count = 0;
    ...
    <style>
      @keyframes spin {
        ...
        this.addEvents = () => {
            ...
            forwardStep === null || forwardStep === void 0 ? void 0 : forwardStep.addEventListener("mouseout", () => (forwardStep.style.opacity = ".8"));
            backStep === null || backStep === void 0 ? void 0 : backStep.addEventListener("mouseover", () => (backStep.style.opacity = "1"));
            backStep === null || backStep === void 0 ? void 0 : backStep.addEventListener("mouseout", () => (backStep.style.opacity = ".8"));
        };
        this.icons = {
            ...
            forwardStep: `<svg style="width:1rem"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path fill="${(_g = this.theme) === null || _g === void 0 ? void 0 : _g.accent}" d="M52.5 440.6c-9.5 7.9-22.8 9.7-34.1 4.4S0 428.4 0 416L0 96C0 83.6 7.2 72.3 18.4 67s24.5-3.6 34.1 4.4l192 160L256 241l0-145c0-17.7 14.3-32 32-32s32 14.3 32 32l0 320c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-145-11.5 9.6-192 160z"/></svg>`,
            backStep: `<svg style="width:1rem"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path fill="${(_h = this.theme) === null || _h === void 0 ? void 0 : _h.accent}" d="M267.5 440.6c9.5 7.9 22.8 9.7 34.1 4.4s18.4-16.6 18.4-29l0-320c0-12.4-7.2-23.7-18.4-29s-24.5-3.6-34.1 4.4l-192 160L64 241 64 96c0-17.7-14.3-32-32-32S0 78.3 0 96L0 416c0 17.7 14.3 32 32 32s32-14.3 32-32l0-145 11.5 9.6 192 160z"/></svg>`,
        };
